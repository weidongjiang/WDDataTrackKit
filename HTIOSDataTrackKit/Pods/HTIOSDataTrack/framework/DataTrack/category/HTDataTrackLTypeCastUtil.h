 ...
 */
NSNumber *htdtl_numberOfValue(id value, NSNumber *defaultValue);
 ...
 */
//CGPoint htdtl_pointOfValue(id value, CGPoint defaultValue);
 ...
 */
//CGSize htdtl_sizeOfValue(id value, CGSize defaultValue);
 ...
 */
//CGRect htdtl_rectOfValue(id value, CGRect defaultValue);
