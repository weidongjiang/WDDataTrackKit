 ...
 *  @return 拼接完成的路径
 */
NSString *ht_LibraryFileWithName(NSString *name);//Library下某个文件
 ...
 *  @return Bundle路径
 */
NSString *ht_NSBundleFolder(void);//BundlePath,iOS下同资源目录
 ...
 *  @return 拼接完成的路径
 */
NSString *ht_ResourceWithName(NSString *name);//资源文件
 ...
 *  @return 拼接完成的路径
 */
NSString *ht_TempFileWithName(NSString *name);//临时目录
 ...
 *  @return 对应位置长度的文件数据
 */
+ (NSData*)ht_dataOfFile:(NSString*)filePath
 ...
 */
+ (BOOL)ht_copyItemAtPath:(NSString*)fromPath
