 ...
 *  @return 数组index对应的对象
 */
- (id)ht_objectAtIndex:(NSUInteger)index  __attribute__((deprecated));
 ...
 */
- (void)ht_enumerateObjectsUsingBlock:(void (^)(id obj, NSUInteger idx, BOOL *stop))block __attribute__((deprecated));
 ...
 *  @param block 数组对象要执行的block
 */
- (void)ht_enumerateObjectsWithOptions:(NSEnumerationOptions)opts usingBlock:(void (^)(id obj, NSUInteger idx, BOOL *stop))block __attribute__((deprecated));
 ...
 *  @return 过滤的结果
 */
@property (nonatomic, copy, readonly) NSArray * ht_stringObjects;
