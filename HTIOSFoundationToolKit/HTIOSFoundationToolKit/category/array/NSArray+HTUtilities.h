...
@property (readonly, getter=ht_arrayBySortingStrings) NSArray *htSortedStrings;

/*!
 *  将数组中的字符串以空格连接组成新字符串返回,如@[@”a”, @”b”];  返回@”a b”.
 */
@property (readonly) NSString *htStringValue;
@end
 ...
 *  @return 合并后的新数组
 */
- (NSArray *)ht_unionWithArray:(NSArray *)array;
 ...
 *  @return 返回包含公共元素的新数组
 */
- (NSArray *)ht_intersectionWithArray:(NSArray *)array;
 ...
 */
- (NSArray *)ht_intersectionWithSet:(NSSet *)set;
 ...
 *  对数组对象操作的相关工具方法。
 */
@interface NSMutableArray (HTTUtilityExtensions)
/*!
...
@property (readonly, getter=ht_reverse) NSMutableArray *ht_reversed;
 ...
 */
@interface NSMutableArray (HTTStackAndQueueExtensions)
 ...
 *  判断当前数组是否为空
 */
@property(nonatomic,readonly,getter=ht_isEmpty) BOOL ht_empty;
